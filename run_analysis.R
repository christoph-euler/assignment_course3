...
setwd("DataScience/coursera/course_03_week_04/UCI HAR Dataset")

# Load feature names
features <- read.table("~/DataScience/coursera/course_03_week_04/UCI HAR Dataset/features.txt")
features <- features$V2

# Loda training and test data
training <- read.table("~/DataScience/coursera/course_03_week_04/UCI HAR Dataset/train/X_train.txt")
colnames(training) <- features
testing <- read.table("~/DataScience/coursera/course_03_week_04/UCI HAR Dataset/test/X_test.txt")
colnames(testing) <- features

# Load subject number
subject_training <- read.table("~/DataScience/coursera/course_03_week_04/UCI HAR Dataset/train/subject_train.txt")
colnames(subject_training) <- "subject_no"
subject_testing <- read.table("~/DataScience/coursera/course_03_week_04/UCI HAR Dataset/test/subject_test.txt")
colnames(subject_testing) <- "subject_no"

# Load activity labels
activity_training <- read.table("~/DataScience/coursera/course_03_week_04/UCI HAR Dataset/train/y_train.txt")
colnames(activity_training) <- "activity"
activity_testing <- read.table("~/DataScience/coursera/course_03_week_04/UCI HAR Dataset/test/y_test.txt")
...
##########################################
# Load activity names
activity_labels <- read.table("~/DataScience/coursera/course_03_week_04/UCI HAR Dataset/activity_labels.txt")
